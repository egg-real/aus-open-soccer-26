...
| -------------- | ------------ | ---------------------------- | ------- | ----------------------------------------------------------------------------------- |
| start_flag     | byte         | 4 bits + 4 bits front padded | 🇦🇺    | All 1s to signal start of a new packet. NOTE: no other byte can have all 1s.        |
| info_bits      | booleans     | 4 bits + 4 bits front padded | bit     | Can see ball, Can see goal, Goal is yellow, Camera is okay.                         |
